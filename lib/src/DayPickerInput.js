...
var DayPickerInput = function (_React$Component) {
  ...
  _createClass(DayPickerInput, [{
    ...
    value: function handlePreviousWeek() {
      ...
      var day = (0, _moment2.default)(value || new Date()).subtract(7, 'days').toDate();
    ...
    value: function handleNextWeek() {
      ...
      console.log(value);
      var day = (0, _moment2.default)(value || new Date()).add(7, 'days').toDate();
      var newValue = formatDate(day, format, dayPickerProps.locale);
      if (dayPickerProps.onDayClick) {
        dayPickerProps.onDayClick(day);
      }
    ...
    value: function handleSnapWeek() {
      ...
      var day = (0, _moment2.default)(new Date()).toDate();
      var newValue = formatDate(day, format, dayPickerProps.locale);
      if (dayPickerProps.onDayClick) {
        dayPickerProps.onDayClick(day);
      }
